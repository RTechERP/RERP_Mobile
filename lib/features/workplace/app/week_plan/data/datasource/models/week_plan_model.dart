...
@freezed
class SubTaskWeekPlan with _$SubTaskWeekPlan {
  const factory SubTaskWeekPlan({
    @JsonKey(name: 'ID') int? id,
    @JsonKey(name: 'Status') int? status,
    @JsonKey(name: 'STT') int? stt,
    @JsonKey(name: 'UserID') int? userId,
...
@freezed
class WeekPlanDetailResponse with _$WeekPlanDetailResponse {
  const factory WeekPlanDetailResponse({
    @JsonKey(name: 'ID') int? id,
    @JsonKey(name: 'Status') int? status,
    @JsonKey(name: 'STT') int? stt,
    @JsonKey(name: 'UserID') int? userId,
    ...
    @JsonKey(name: 'EstimatedTime') double? estimatedTime,
    @JsonKey(name: 'NeedApprove') bool? needApprove,
  }) = _WeekPlanDetailResponse;

  factory WeekPlanDetailResponse.fromJson(
      Map<String, dynamic> json,
      ) =>
      _$WeekPlanDetailResponseFromJson(json);
}

@freezed
class WeekPlanTypeEmployeeDetailResponse
    with _$WeekPlanTypeEmployeeDetailResponse {
  const factory WeekPlanTypeEmployeeDetailResponse({
    @JsonKey(name: 'ID') int? id,
    @JsonKey(name: 'ProjectTaskID') int? projectTaskId,
    @JsonKey(name: 'EmployeeID') int? employeeId,
    @JsonKey(name: 'Type') int? type,
    ...
    @JsonKey(name: 'UpdatedBy') String? updatedBy,
    @JsonKey(name: 'IsDeleted') bool? isDeleted,
  }) = _WeekPlanTypeEmployeeDetailResponse;

  factory WeekPlanTypeEmployeeDetailResponse.fromJson(
      Map<String, dynamic> json,
      ) =>
