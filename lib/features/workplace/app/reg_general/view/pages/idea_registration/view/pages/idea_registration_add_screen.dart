      ...
      children: [
        Expanded(
          child: FormDateTimePicker(
            ...
            isRequired: true,
            initialValue: state.dateStartForm ?? DateTime.now(),
        ...
        Expanded(
          child: FormDateTimePicker(
            ...
            format: DateFormat('dd/MM/yyyy'),
            isRequired: true,
            initialValue: state.dateEndForm ?? DateTime.now().add(const Duration(days: 30)),
            firstDate: state.dateStartForm ?? DateTime.now(),
            ...
            validator: (v) {
              if (v == null) return 'Chọn ngày';
              final start = state.dateStartForm;
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSelectField(
            ...
            icon: Icons.business,
            value: state.departmentOrganizationName,
