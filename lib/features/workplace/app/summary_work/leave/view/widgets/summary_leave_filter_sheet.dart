...
enum LeaveFilterStatus {
  all(-1, 'Tất cả'),
  pending(0, 'Chưa duyệt'),
  approved(1, 'Đã duyệt');

  const LeaveFilterStatus(this.value, this.label);
  final int value;
  final String label;
}

class SummaryLeaveFilterSheet extends StatefulWidget {
  const SummaryLeaveFilterSheet({
    super.key,
  ...
  @override
  State<SummaryLeaveFilterSheet> createState() => _SummaryLeaveFilterSheetState();
}

class _SummaryLeaveFilterSheetState extends State<SummaryLeaveFilterSheet> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: widget.departments.map((dept) => _buildDepartmentChip(
                      id: dept.id,
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: LeaveFilterStatus.values.map((opt) {
