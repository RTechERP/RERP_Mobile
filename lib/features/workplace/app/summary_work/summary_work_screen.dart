...
class SummaryWorkScreen extends StatelessWidget {
  const SummaryWorkScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final items = AppItemRegistry.summarywork;

    return BaseScaffold(
      appBar: AppBarCommon(
        title: Text(
          'applications.summary_work'.tr(),
        ...
        child: SingleChildScrollView(
          child: SafeArea(
            child: Column(
              children: [
                WpActionCard(
                  title: 'applications.summary_work'.tr(),
                  expandable: true,
