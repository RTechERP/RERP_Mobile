...
/// Enum trạng thái dùng cho bộ lọc phiếu làm đêm.
enum OvernightFilterStatus {
  all(-1, 'Tất cả'),
  pending(0, 'Chưa duyệt'),
  approved(1, 'Đã duyệt');

  const OvernightFilterStatus(this.value, this.label);
  final int value;
  final String label;
}

/// Bottom sheet bộ lọc cho màn tổng hợp phiếu làm đêm.
class SummaryOvernightFilterSheet extends StatefulWidget {
  const SummaryOvernightFilterSheet({
    super.key,
  ...
  @override
  State<SummaryOvernightFilterSheet> createState() =>
      _SummaryOvernightFilterSheetState();
}

class _SummaryOvernightFilterSheetState
    extends State<SummaryOvernightFilterSheet> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: OvernightFilterStatus.values
