...
enum WfhFilterStatus {
  all(-1, 'Tất cả'),
  pending(0, 'Chưa duyệt'),
  approved(1, 'Đã duyệt');

  const WfhFilterStatus(this.value, this.label);
  final int value;
  final String label;
}

class SummaryWfhFilterSheet extends StatefulWidget {
  const SummaryWfhFilterSheet({
    super.key,
  ...
  @override
  State<SummaryWfhFilterSheet> createState() => _SummaryWfhFilterSheetState();
}

class _SummaryWfhFilterSheetState extends State<SummaryWfhFilterSheet> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: WfhFilterStatus.values
