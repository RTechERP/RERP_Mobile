...
/// Enum trạng thái dùng cho bộ lọc phiếu quên chấm công.
enum MissedFilterStatus {
  all(-1, 'Tất cả'),
  pending(0, 'Chưa duyệt'),
  approved(1, 'Đã duyệt');

  const MissedFilterStatus(this.value, this.label);
  final int value;
  final String label;
}

/// Bottom sheet bộ lọc cho màn tổng hợp phiếu quên chấm công.
class SummaryMissedFilterSheet extends StatefulWidget {
  const SummaryMissedFilterSheet({
    super.key,
  ...
  @override
  State<SummaryMissedFilterSheet> createState() =>
      _SummaryMissedFilterSheetState();
}

class _SummaryMissedFilterSheetState extends State<SummaryMissedFilterSheet> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: MissedFilterStatus.values
