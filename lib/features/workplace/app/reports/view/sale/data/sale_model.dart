...
class SaleStaffWork extends Equatable {
  ...
  /// Convert từ DetailSaleReportResponse (API getSaleById) dùng cho màn edit.
  factory SaleStaffWork.fromDetailSaleReportResponse(
    DetailSaleReportResponse d,
  ) {
    return SaleStaffWork(
      id: d.id,
      userId: d.userId,
      employeeId: d.userLoginId,
      dateReport: null,
      code: '',
      fullName: '',
      projectCode: null,
      ...
      content: d.content,
      results: d.result ?? '',
      planNextDay: d.planNext ?? '',
      backlog: d.problemBacklog,
      problem: d.problemBacklog,
      note: d.note,
      ...
      firmId: d.firmBaseId,
      firmName: null,
      typeProjectId: d.projectTypeBaseId,
      typeProjectName: null,
      customerId: d.customerId,
      customerName: null,
      customerCode: null,
      typeTeamSaleId: d.groupType,
      typeTeamSaleMainIndex: null,
      statusProjectId: null,
      statusProjectName: null,
      indexStatusProject: null,
      customerContactId: d.contacId,
      customerContactName: null,
      customerContactPhone: null,
      customerContactTeam: null,
      customerContactPart: null,
      customerContactPosition: null,
      customerPartId: d.endUser,
      customerPartName: null,
      customerPartCode: null,
      indexCustomerPart: null,
      saleOpportunity: d.saleOpportunity ?? false,
      bigAccount: d.bigAccount,
      customerProduct: d.productOfCustomer,
