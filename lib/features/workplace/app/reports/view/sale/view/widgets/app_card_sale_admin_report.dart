        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  if (reportTypeName?.isNotEmpty == true)
                    _badge(reportTypeName!, Colors.orange),
              ...
              /// EMPLOYEE
              if (employeeFullName?.isNotEmpty == true)
                Row(
                  children: [
              ...
              Row(
                ...
                children: [
                  Expanded(child: _gridItem("Nội dung", reportContent)),
              ...
              _gridItem("Kế hoạch", planNextDay),
            ],
          ),
        ),
      ),
