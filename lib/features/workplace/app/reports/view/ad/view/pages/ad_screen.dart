...
class _AdScreenState
    extends BaseState<AdScreen, AdEvent, AdState, AdBloc> {
  ...
  Widget _buildDateHeader(AdState state) {
    String text;
  ...
  Widget renderUI(BuildContext context) {
    return BlocListener<AdBloc, AdState>(
      ...
      listener: (context, state) async {
        ...
        //   bloc.add(const AdEvent.resetCopyReport());
        // }
      },
      child: BaseScaffold(
        appBar: AppBarCommon(
                        ...
                        Widget card = AppCardReport(
                          ...
                          onTap: hasData
                            ...
                            final reload = await context.push(
                              RouteNames.reportADdepartDetail,
                              extra: r.id,
                            );
                            ...
                            children: [
                              SlidableAction(
                                onPressed: (_) async {
                                  ...
                                  bloc.add(AdEvent.deleteReport(r.id));
                                },
...
class AdDateRangePicker {
  ...
  static void open(BuildContext context, AdBloc bloc) {
    final now = DateTime.now();
