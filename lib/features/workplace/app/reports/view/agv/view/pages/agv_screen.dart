...
class AgvScreen extends StatefulWidget {
  const AgvScreen({super.key});

  @override
  State<AgvScreen> createState() => _AgvScreenState();
}

class _AgvScreenState
    extends BaseState<AgvScreen, AgvEvent, AgvState, AgvBloc> {
  ...
  Widget _buildDateHeader(AgvState state) {
    String text;
  ...
  Widget renderUI(BuildContext context) {
    return BlocListener<AgvBloc, AgvState>(
      ...
      listener: (context, state) async {
        ...
        //   bloc.add(const AgvEvent.resetCopyReport());
        // }
      },
      child: BaseScaffold(
        appBar: AppBarCommon(
                            ...
                            children: [
                              SlidableAction(
                                onPressed: (_) async {
                                  ...
                                  bloc.add(AgvEvent.deleteReport(r.id));
                                },
        ...
        floatingActionButton: SpeedDial(
          ...
          children: [
            ...
            SpeedDialChild(
              ...
              label: 'Thêm',
              onTap: () async {
                final reload = await context.push(RouteNames.reportAGVdepartAdd);
            ...
            SpeedDialChild(
              ...
              label: 'Lọc ngày',
              onTap: () {
                AgvDateRangePicker.open(context, bloc);
              },
            ),
...
class AgvDateRangePicker {
  ...
  static void open(BuildContext context, AgvBloc bloc) {
    final now = DateTime.now();
