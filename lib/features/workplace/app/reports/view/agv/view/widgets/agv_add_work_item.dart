...
class AgvAddWorkItem extends StatefulWidget {
  final String title;
  final AgvWork report;
  ...
  @override
  State<AgvAddWorkItem> createState() => _AgvAddWorkItemState();
}

class _AgvAddWorkItemState extends State<AgvAddWorkItem> {
  ...
  @override
  void didUpdateWidget(covariant AgvAddWorkItem oldWidget) {
  ...
  Widget _buildContent(BuildContext context) {
    return BlocBuilder<AgvBloc, AgvState>(
      buildWhen: (prev, curr) =>
        ...
        return Column(
          children: [
            ...
            GestureDetector(
              ...
              child: AbsorbPointer(
                child: FormInputField(
                  ...
                  nameForm: 'agv_project_${widget.report.id}',
              ...
              children: [
                Expanded(
                  child: FormInputField(
                    ...
                    nameForm: 'agv_add_total_${widget.report.id}',
                ...
                Expanded(
                  child: FormInputField(
                    icon: Icons.timer_outlined,
                    nameForm: 'agv_add_ot_${widget.report.id}',
            ...
            FormInputField(
              ...
              nameForm: 'agv_add_content_${widget.report.id}',
            ...
            FormInputField(
              ...
              icon: Icons.note_outlined,
              nameForm: 'agv_add_result_${widget.report.id}',
