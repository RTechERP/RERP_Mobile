...
class AgvDetailScreen extends StatefulWidget {
  const AgvDetailScreen({super.key});

  @override
  State<AgvDetailScreen> createState() => _AgvDetailScreenState();
}

class _AgvDetailScreenState
    extends BaseState<AgvDetailScreen, AgvEvent, AgvState, AgvBloc> {
  int? _dailyId;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (extra is int) {
        _dailyId = extra;
        bloc.add(AgvEvent.selectReport(dailyID: _dailyId!));
      }
    });
  }
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    final result = await context.push(
                      RouteNames.reportAGVdepartEdit,
                      extra: _dailyId,
                    );
