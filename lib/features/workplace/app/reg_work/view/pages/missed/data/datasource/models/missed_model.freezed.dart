...
MissedItem _$MissedItemFromJson(Map<String, dynamic> json) {
  return _MissedItem.fromJson(json);
}
...
mixin _$MissedItem {
  ...
  @JsonKey(name: 'DayWork')
  DateTime? get dayWork => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $MissedItemCopyWith<MissedItem> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $MissedItemCopyWith<$Res> {
  factory $MissedItemCopyWith(
          MissedItem value, $Res Function(MissedItem) then) =
      _$MissedItemCopyWithImpl<$Res, MissedItem>;
  @useResult
  $Res call(
...
/// @nodoc
class _$MissedItemCopyWithImpl<$Res, $Val extends MissedItem>
    implements $MissedItemCopyWith<$Res> {
  _$MissedItemCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      approvedTP: freezed == approvedTP
          ...
          : approvedTP // ignore: cast_nullable_to_non_nullable
              as int?,
      dayWork: freezed == dayWork
          ? _value.dayWork
          : dayWork // ignore: cast_nullable_to_non_nullable
              as DateTime?,
...
/// @nodoc
abstract class _$$MissedItemImplCopyWith<$Res>
    implements $MissedItemCopyWith<$Res> {
  factory _$$MissedItemImplCopyWith(
          _$MissedItemImpl value, $Res Function(_$MissedItemImpl) then) =
      __$$MissedItemImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'ID') int id,
...
/// @nodoc
class __$$MissedItemImplCopyWithImpl<$Res>
    extends _$MissedItemCopyWithImpl<$Res, _$MissedItemImpl>
    implements _$$MissedItemImplCopyWith<$Res> {
  __$$MissedItemImplCopyWithImpl(
      _$MissedItemImpl _value, $Res Function(_$MissedItemImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$MissedItemImpl implements _MissedItem {
  const _$MissedItemImpl(
      {@JsonKey(name: 'ID') required this.id,
      @JsonKey(name: 'EmployeeID') this.employeeId,
      @JsonKey(name: 'ApprovedTP') this.approvedTP,
      @JsonKey(name: 'DayWork') this.dayWork,
  ...
  factory _$MissedItemImpl.fromJson(Map<String, dynamic> json) =>
      _$$MissedItemImplFromJson(json);
  ...
  @override
  String toString() {
    return 'MissedItem(id: $id, employeeId: $employeeId, approvedTP: $approvedTP, dayWork: $dayWork, isApprovedTP: $isApprovedTP, note: $note, createdBy: $createdBy, createdDate: $createdDate, updatedBy: $updatedBy, updatedDate: $updatedDate, approvedHR: $approvedHR, isApprovedHR: $isApprovedHR, type: $type, decilineApprove: $decilineApprove, reasonDeciline: $reasonDeciline, reasonHREdit: $reasonHREdit, isDeleted: $isDeleted, isSeniorApproved: $isSeniorApproved, approvedSeniorID: $approvedSeniorID, dateApprovedSenior: $dateApprovedSenior, decilineApproveSenior: $decilineApproveSenior, reasonDecilineSenior: $reasonDecilineSenior, code: $code, fullName: $fullName, departmentId: $departmentId, departmentName: $departmentName, rowNumber: $rowNumber, approvedName: $approvedName, statusNumber: $statusNumber, statusHRNumber: $statusHRNumber, typeText: $typeText, statusText: $statusText, statusHRText: $statusHRText)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MissedItemImplCopyWith<_$MissedItemImpl> get copyWith =>
      __$$MissedItemImplCopyWithImpl<_$MissedItemImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MissedItemImplToJson(
      this,
    );
  }
}

abstract class _MissedItem implements MissedItem {
  const factory _MissedItem(
      {@JsonKey(name: 'ID') required final int id,
      @JsonKey(name: 'EmployeeID') final int? employeeId,
      @JsonKey(name: 'ApprovedTP') final int? approvedTP,
      @JsonKey(name: 'DayWork') final DateTime? dayWork,
      ...
      @JsonKey(name: 'StatusHRText')
      final String? statusHRText}) = _$MissedItemImpl;

  factory _MissedItem.fromJson(Map<String, dynamic> json) =
      _$MissedItemImpl.fromJson;
