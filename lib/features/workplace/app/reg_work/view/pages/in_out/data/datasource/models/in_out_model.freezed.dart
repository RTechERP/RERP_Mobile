...
InOutItem _$InOutItemFromJson(Map<String, dynamic> json) {
  return _InOutItem.fromJson(json);
}
...
mixin _$InOutItem {
  ...
  @JsonKey(name: 'TimeRegister')
  int? get timeRegister => throw _privateConstructorUsedError;
  @JsonKey(name: 'IsSeniorApprovedText')
  String? get isSeniorApprovedText => throw _privateConstructorUsedError;
  @JsonKey(name: 'ApprovedSđreniorName')
  ...
  @JsonKey(ignore: true)
  $InOutItemCopyWith<InOutItem> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $InOutItemCopyWith<$Res> {
  factory $InOutItemCopyWith(InOutItem value, $Res Function(InOutItem) then) =
      _$InOutItemCopyWithImpl<$Res, InOutItem>;
  @useResult
  $Res call(
...
/// @nodoc
class _$InOutItemCopyWithImpl<$Res, $Val extends InOutItem>
    implements $InOutItemCopyWith<$Res> {
  _$InOutItemCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      statusHRNumber: freezed == statusHRNumber
          ...
          : statusHRNumber // ignore: cast_nullable_to_non_nullable
              as int?,
      timeRegister: freezed == timeRegister
          ? _value.timeRegister
...
/// @nodoc
abstract class _$$InOutItemImplCopyWith<$Res>
    implements $InOutItemCopyWith<$Res> {
  factory _$$InOutItemImplCopyWith(
          _$InOutItemImpl value, $Res Function(_$InOutItemImpl) then) =
      __$$InOutItemImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'ID') int id,
...
/// @nodoc
class __$$InOutItemImplCopyWithImpl<$Res>
    extends _$InOutItemCopyWithImpl<$Res, _$InOutItemImpl>
    implements _$$InOutItemImplCopyWith<$Res> {
  __$$InOutItemImplCopyWithImpl(
      _$InOutItemImpl _value, $Res Function(_$InOutItemImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$InOutItemImpl implements _InOutItem {
  const _$InOutItemImpl(
      ...
      @JsonKey(name: 'TimeRegister') this.timeRegister,
      @JsonKey(name: 'IsSeniorApprovedText') this.isSeniorApprovedText,
      @JsonKey(name: 'ApprovedSđreniorName') this.approvedSeniorName,
  ...
  factory _$InOutItemImpl.fromJson(Map<String, dynamic> json) =>
      _$$InOutItemImplFromJson(json);
  ...
  @override
  String toString() {
    return 'InOutItem(id: $id, employeeId: $employeeId, approvedId: $approvedId, isApproved: $isApproved, dateRegister: $dateRegister, unit: $unit, type: $type, reason: $reason, createdDate: $createdDate, createdBy: $createdBy, updatedDate: $updatedDate, updatedBy: $updatedBy, approvedTP: $approvedTP, isApprovedTP: $isApprovedTP, decilineApprove: $decilineApprove, dateStart: $dateStart, dateEnd: $dateEnd, reasonDeciline: $reasonDeciline, reasonHREdit: $reasonHREdit, isProblem: $isProblem, typeText: $typeText, rowNum: $rowNum, fullName: $fullName, code: $code, departmentId: $departmentId, departmentName: $departmentName, approvedName: $approvedName, statusNumber: $statusNumber, statusHRNumber: $statusHRNumber, timeRegister: $timeRegister, isSeniorApprovedText: $isSeniorApprovedText, approvedSeniorName: $approvedSeniorName, fileName: $fileName, filePath: $filePath, checkIn: $checkIn, checkOut: $checkOut, isNotValid: $isNotValid, statusText: $statusText, statusHRText: $statusHRText, totalPage: $totalPage)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$InOutItemImplCopyWith<_$InOutItemImpl> get copyWith =>
      __$$InOutItemImplCopyWithImpl<_$InOutItemImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$InOutItemImplToJson(
      this,
    );
  }
}

abstract class _InOutItem implements InOutItem {
  const factory _InOutItem(
      ...
      @JsonKey(name: 'TimeRegister') final int? timeRegister,
      ...
      @JsonKey(name: 'TotalPage') final int? totalPage}) = _$InOutItemImpl;

  factory _InOutItem.fromJson(Map<String, dynamic> json) =
      _$InOutItemImpl.fromJson;
