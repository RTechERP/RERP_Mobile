...
OvernightItem _$OvernightItemFromJson(Map<String, dynamic> json) {
  return _OvernightItem.fromJson(json);
}

/// @nodoc
mixin _$OvernightItem {
  @JsonKey(name: 'ID')
  ...
  @JsonKey(ignore: true)
  $OvernightItemCopyWith<OvernightItem> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OvernightItemCopyWith<$Res> {
  factory $OvernightItemCopyWith(
          OvernightItem value, $Res Function(OvernightItem) then) =
      _$OvernightItemCopyWithImpl<$Res, OvernightItem>;
  @useResult
  $Res call(
...
/// @nodoc
class _$OvernightItemCopyWithImpl<$Res, $Val extends OvernightItem>
    implements $OvernightItemCopyWith<$Res> {
  _$OvernightItemCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$OvernightItemImplCopyWith<$Res>
    implements $OvernightItemCopyWith<$Res> {
  factory _$$OvernightItemImplCopyWith(
          _$OvernightItemImpl value, $Res Function(_$OvernightItemImpl) then) =
      __$$OvernightItemImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'ID') int id,
...
/// @nodoc
class __$$OvernightItemImplCopyWithImpl<$Res>
    extends _$OvernightItemCopyWithImpl<$Res, _$OvernightItemImpl>
    implements _$$OvernightItemImplCopyWith<$Res> {
  __$$OvernightItemImplCopyWithImpl(
      _$OvernightItemImpl _value, $Res Function(_$OvernightItemImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OvernightItemImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$OvernightItemImpl implements _OvernightItem {
  const _$OvernightItemImpl(
  ...
  factory _$OvernightItemImpl.fromJson(Map<String, dynamic> json) =>
      _$$OvernightItemImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OvernightItemImplCopyWith<_$OvernightItemImpl> get copyWith =>
      __$$OvernightItemImplCopyWithImpl<_$OvernightItemImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OvernightItemImplToJson(
      this,
    );
  }
}

abstract class _OvernightItem implements OvernightItem {
  const factory _OvernightItem(
  ...
  factory _OvernightItem.fromJson(Map<String, dynamic> json) =
      _$OvernightItemImpl.fromJson;
