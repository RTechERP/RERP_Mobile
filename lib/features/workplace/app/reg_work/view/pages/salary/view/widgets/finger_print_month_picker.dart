...
class FingerPrintMonthPicker extends StatefulWidget {
  final DateTime? selectedMonth;
  final void Function(DateTime month) onApply;

  const FingerPrintMonthPicker({
    super.key,
    this.selectedMonth,
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet(
      ...
      builder: (_) => FingerPrintMonthPicker(
  ...
  @override
  State<FingerPrintMonthPicker> createState() =>
      _FingerPrintMonthPickerState();
}

class _FingerPrintMonthPickerState extends State<FingerPrintMonthPicker> {
